...
<li><a href="testpage.jsp?query=dwoadw1">dwoadw1</a></li>
<li><a href="testpage.jsp?query=dwoadw2">dwoadw2</a></li>
<li><a href="testpage.jsp?query=adventureworks">adventureworksfix</a></li>
