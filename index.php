...
$sql = "SELECT SUM(total_gaji) as total_gaji, CEIL(AVG(lama_bekerja)) as lama_bekerja, CEIL(MAX(ratarata_gaji)) as ratarata_gaji from fact_hr  ";
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?= $lama_bekerja; ?> tahun</h3>

                <p style="font-size: 15px">Rata-Rata Lama Karyawan bekerja</p>
              </div>
              <div class="icon">
        ...
        <div class="col">
          ...
          <iframe class="col" src="http://localhost:9191/mondrian/testpage.jsp?query=adventureworks" width="700" height="500"></iframe>
